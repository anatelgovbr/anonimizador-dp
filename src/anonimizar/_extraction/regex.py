    ...
    for pattern in patterns:
        ...
        for entidade_regex in entidades_regex:
            verifica_entidade = verify_fn(
                {
                    ...
                    "start_char": entidade_regex["start_position"],
                    "end_char": entidade_regex["end_position"],
                },
                text,
            )
            ...
            if str(verifica_entidade) != "False":
                ...
                final_label = entidade_regex["label"] if str(verifica_entidade) == "True" else verifica_entidade

                entity_dict = _create_entity_dict(
                    final_label,
                    entidade_regex["start_position"],
                    entidade_regex["end_position"],
                    entidade_regex["text"],
