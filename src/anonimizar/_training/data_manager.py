...
de dados de treinamento: adição, validação e divisão treino/validação.
"""
...
class NERDataManager:
    ...
    - Validar formato e consistência dos dados
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            supported_labels: Labels aceitos para validação.
                Se None ou vazio, todos os labels são aceitos.
    ...
    def add_data(
        ...
        *,
        ...
        Args:
            ...
            auto_clean: Se True, remove entidades inválidas automaticamente.
            strict_clean: Se True e auto_clean=True, descarta exemplos com entidades removidas.
            keep_empty_entities: Se True, mantém exemplos sem entidades após limpeza.
            resolve_conflicts: Estratégia de conflitos (``'raise'``, ``'ignore'``, ``'coerce'``).
        ...
        if load_jsonl_fn is None:
            from anonimizar._training.io_handler import load_from_doccano_jsonl as _load_jsonl  # noqa: PLC0415
        else:
        ...
        if auto_clean:
            from anonimizar._training import data_validator  # noqa: PLC0415
