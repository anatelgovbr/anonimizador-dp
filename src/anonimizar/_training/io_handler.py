...
def load_from_doccano_jsonl(
    ...
    Example:
        ```python
        data = load_from_doccano_jsonl("/caminho/para/anotacoes.jsonl")
        ```
    """
...
def save_to_doccano_jsonl(
    ...
    *,
    ...
    Example:
        ...
        save_to_doccano_jsonl("/caminho/para/saida.jsonl", data)
        ```
    """
...
def load_jsonl_to_dataframes(
    ...
    Example:
        ```python
        df_textos, df_entidades = load_jsonl_to_dataframes("/caminho/para/anotacoes.jsonl")
        ```
    """
