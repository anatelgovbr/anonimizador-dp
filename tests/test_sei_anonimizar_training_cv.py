"""Testes para cross-validation do módulo SeiAnonimizarNERTrainer."""
...
class TestCrossValidate:
    ...
    def test_cross_validate_stratified(self, sample_entidades, sample_textos, temp_dir):
        ...
        trainer = SeiAnonimizarNERTrainer(model_name=None, labels=["CPF", "EMAIL", "TELEFONE"])
    ...
    def test_cross_validate_saves_fold_ids(self, sample_entidades, sample_textos, temp_dir):
        ...
        for fold_dir in fold_dirs:
            ...
            with open(fold_ids_json, "r", encoding="utf-8") as f:
    ...
    def test_cross_validate_with_jsonl_input(self, temp_dir):
        ...
        trainer = SeiAnonimizarNERTrainer(model_name=None, labels=["CPF", "EMAIL"])
